...
class Board:
    def __init__(self, fen=STARTING_FEN):
        ...
        self.white_attacked_squares = []    # list of squares attacked by white (used by is_check)
        self.black_attacked_squares = []    # list of squares attacked by black (used by is check)
