...
class ChessGame:
    def __init__(self, screen):
        ...
        self.engine = Engine(self.board, depth=4, time_limit=5)
    ...
    def developer_display(self):
        ...
        FEN_rect = pygame.Rect(0, 200, 800, 100)
        ...
        # write the engine evaluation of the board to the screen
        evaluation_rect = pygame.Rect(100, 400, 100, 100)
        write_centered_text(self.screen, str(self.engine.evaluate_board()), evaluation_rect, (0, 0, 0))
